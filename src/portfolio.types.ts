  ...
  .object({
    ...
    account: z
      .object({
        ...
        institution: z
          .object({ id: z.string(), name: z.string(), __typename: z.string().optional() })
          .strict()
          .optional(),
        type: z
          .object({ name: z.string(), display: z.string(), __typename: z.string().optional() })
          .strict()
          .optional(),
        subtype: z
          .object({ name: z.string(), display: z.string(), __typename: z.string().optional() })
...
export const AggregateHoldingSchema = z
  .object({
    id: z.string(),
    quantity: z.number(),
    basis: z.number(),
...
export const AggregateHoldingEdgeSchema = z
  .object({
...
export const AggregateHoldingConnectionSchema = z
  .object({
...
export const HistoricalChartPointSchema = z
  .object({
    date: z.string(),
...
export const BenchmarkSecuritySchema = z
  .object({
    id: z.string(),
    ticker: z.string(),
    name: z.string(),
