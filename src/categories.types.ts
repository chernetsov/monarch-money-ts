...
export const BudgetCategoryGroupSchema = z
  .object({
    id: z.string(),
    name: z.string(),
    order: z.number(),
 ...
 */
export const CategoryGroupSummarySchema = z
  .object({
    id: z.string(),
...
export type BudgetCategoryGroupWithBudgeting = z.infer<
  typeof BudgetCategoryGroupWithBudgetingSchema
>;
...
export const ManageCategoryGroupsResponseSchema = z
  .object({
...
export const BudgetCategoryDetailGroupSchema = z
  .object({
    id: z.string(),
    type: z.string(),
    groupLevelBudgetingEnabled: z.boolean(),
...
export const BudgetCategoryRolloverPeriodSchema = z
  .object({
    id: z.string(),
    startMonth: z.string(),
    startingBalance: z.number(),
...
export const BudgetCategoryDetailSchema = z
  .object({
    id: z.string(),
    order: z.number(),
    name: z.string(),
...
export const GetBudgetCategoryResponseSchema = z
  .object({
