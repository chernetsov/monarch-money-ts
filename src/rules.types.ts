 ...
 */
export const TransactionRuleSummarySchema = z
  .object({
    id: z.string(),
...
export const MerchantCriterionSchema = z
  .object({
...
export const AmountCriteriaValueRangeSchema = z
  .object({
    lower: z.number(),
    upper: z.number(),
    __typename: z.string().optional(),
...
export const AmountCriteriaSchema = z
  .object({
 ...
 */
export const RuleCategorySummarySchema = z
  .object({
    id: z.string(),
    name: z.string(),
    icon: z.string(),
 ...
 */
export const RuleAccountSummarySchema = z
  .object({
    id: z.string(),
 ...
 */
export const RuleMerchantSummarySchema = z
  .object({
    id: z.string(),
    name: z.string(),
    __typename: z.string().optional(),
 ...
 */
export const RuleGoalSummarySchema = z
  .object({
    id: z.string(),
    name: z.string(),
 ...
 */
export const RuleTagSummarySchema = z
  .object({
    id: z.string(),
    name: z.string(),
    color: z.string(),
...
export const SplitTransactionInfoSchema = z
  .object({
...
export const SplitTransactionsActionSchema = z
  .object({
    amountType: z.string(),
...
export const GetTransactionRulesResponseSchema = z
  .object({
 ...
 */
export const RulePreviewTransactionSchema = z
  .object({
    id: z.string(),
    date: z.string(),
    amount: z.number(),
 ...
 */
export const RulePreviewResultSchema = z
  .object({
...
export const TransactionRulePreviewSchema = z
  .object({
    totalCount: z.number(),
...
export const PreviewTransactionRuleResponseSchema = z
  .object({
